...
export default function Products() {
   ...
   async function deleteProduct(id){
    ...
    return (
        ...
        <h1 style={{textAlign:'center',color:'green'}}>Add Product</h1>
        <div className="add-ads-form"  onSubmit={handleSubmit(onSubmit)}>
            <form className={classes.root} noValidate autoComplete="on" onSubmit={handleSubmit(onSubmit)}>
                ...
                <Button variant="contained"  type="submit" style={{backgroundColor: 'green' , color : 'white'}}>Add Product</Button>
                </FormControl>
            </form>
        </div>
        <h1 style={{textAlign:'center',color:'green'}}>Products List</h1>
